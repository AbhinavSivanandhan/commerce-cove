...
router.post('/add', authMiddleware(['customer']), rateLimitMiddleware(1000, 3600, 1000), addToCart);
router.get('/view', authMiddleware(['customer']), rateLimitMiddleware(500, 3600, 1000), viewCart);
